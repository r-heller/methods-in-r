...
Weekly one-page summaries from the original `CTTIR/courses` labs, aggregated here as a printable reference. Each is a self-contained reminder of the syntax, the assumptions, and the diagnostics that go with the methods covered that week.
...
## Course 3 — Design & Causal Inference
...
## Course 4 — Machine Learning & High-Dimensional Data
