...
**Reviewer checklist for this method.** → [`bwa-bowtie-alignment` — For Reviewers](../chapters/12-bioinformatics/bwa-bowtie-alignment.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`atac-seq-analysis` — For Reviewers](../chapters/12-bioinformatics/atac-seq-analysis.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`batch-correction-combat` — For Reviewers](../chapters/12-bioinformatics/batch-correction-combat.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`bulk-rnaseq-differential-expression` — For Reviewers](../chapters/12-bioinformatics/bulk-rnaseq-differential-expression.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-cell-type-annotation` — For Reviewers](../chapters/12-bioinformatics/scrna-cell-type-annotation.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`chip-seq-analysis` — For Reviewers](../chapters/12-bioinformatics/chip-seq-analysis.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`cnv-analysis` — For Reviewers](../chapters/12-bioinformatics/cnv-analysis.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`counting-reads-feature-counts` — For Reviewers](../chapters/12-bioinformatics/counting-reads-feature-counts.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`edger-differential-expression` — For Reviewers](../chapters/12-bioinformatics/edger-differential-expression.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`limma-voom` — For Reviewers](../chapters/12-bioinformatics/limma-voom.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`methylation-analysis` — For Reviewers](../chapters/12-bioinformatics/methylation-analysis.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`drug-target-interaction` — For Reviewers](../chapters/12-bioinformatics/drug-target-interaction.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`fastq-quality-control` — For Reviewers](../chapters/12-bioinformatics/fastq-quality-control.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-marker-genes` — For Reviewers](../chapters/12-bioinformatics/scrna-marker-genes.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`biomart-annotation` — For Reviewers](../chapters/12-bioinformatics/biomart-annotation.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`gene-ontology-enrichment` — For Reviewers](../chapters/12-bioinformatics/gene-ontology-enrichment.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`gsea-preranked` — For Reviewers](../chapters/12-bioinformatics/gsea-preranked.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`gsva-single-sample` — For Reviewers](../chapters/12-bioinformatics/gsva-single-sample.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`heatmaps-rnaseq` — For Reviewers](../chapters/12-bioinformatics/heatmaps-rnaseq.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-integration-harmony` — For Reviewers](../chapters/12-bioinformatics/scrna-integration-harmony.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`pathway-enrichment-kegg` — For Reviewers](../chapters/12-bioinformatics/pathway-enrichment-kegg.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`ma-plots` — For Reviewers](../chapters/12-bioinformatics/ma-plots.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`metagenomic-profiling` — For Reviewers](../chapters/12-bioinformatics/metagenomic-profiling.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`microbiome-dada2` — For Reviewers](../chapters/12-bioinformatics/microbiome-dada2.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`microbiome-diversity` — For Reviewers](../chapters/12-bioinformatics/microbiome-diversity.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`multiomics-integration` — For Reviewers](../chapters/12-bioinformatics/multiomics-integration.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`msa-biostrings` — For Reviewers](../chapters/12-bioinformatics/msa-biostrings.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`pca-of-rnaseq` — For Reviewers](../chapters/12-bioinformatics/pca-of-rnaseq.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`phylogenetic-trees-ape` — For Reviewers](../chapters/12-bioinformatics/phylogenetic-trees-ape.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`population-genetics-basics` — For Reviewers](../chapters/12-bioinformatics/population-genetics-basics.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`protein-structure-prediction` — For Reviewers](../chapters/12-bioinformatics/protein-structure-prediction.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`proteomics-msstats` — For Reviewers](../chapters/12-bioinformatics/proteomics-msstats.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`salmon-kallisto-pseudoalignment` — For Reviewers](../chapters/12-bioinformatics/salmon-kallisto-pseudoalignment.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`read-trimming-adapters` — For Reviewers](../chapters/12-bioinformatics/read-trimming-adapters.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`rnaseq-normalization` — For Reviewers](../chapters/12-bioinformatics/rnaseq-normalization.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-clustering` — For Reviewers](../chapters/12-bioinformatics/scrna-clustering.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-normalization` — For Reviewers](../chapters/12-bioinformatics/scrna-normalization.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-qc-filtering` — For Reviewers](../chapters/12-bioinformatics/scrna-qc-filtering.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`sequence-alignment-overview` — For Reviewers](../chapters/12-bioinformatics/sequence-alignment-overview.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`single-cell-seurat-intro` — For Reviewers](../chapters/12-bioinformatics/single-cell-seurat-intro.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`spatial-transcriptomics` — For Reviewers](../chapters/12-bioinformatics/spatial-transcriptomics.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`star-spliced-alignment` — For Reviewers](../chapters/12-bioinformatics/star-spliced-alignment.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`structural-variant-detection` — For Reviewers](../chapters/12-bioinformatics/structural-variant-detection.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`surrogate-variable-analysis-sva` — For Reviewers](../chapters/12-bioinformatics/surrogate-variable-analysis-sva.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`scrna-trajectory-analysis` — For Reviewers](../chapters/12-bioinformatics/scrna-trajectory-analysis.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`tx-to-gene-summarization` — For Reviewers](../chapters/12-bioinformatics/tx-to-gene-summarization.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`annotation-variant-vep` — For Reviewers](../chapters/12-bioinformatics/annotation-variant-vep.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`variant-calling-gatk` — For Reviewers](../chapters/12-bioinformatics/variant-calling-gatk.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`vcf-manipulation` — For Reviewers](../chapters/12-bioinformatics/vcf-manipulation.qmd#for-reviewers)
...
**Reviewer checklist for this method.** → [`volcano-plots` — For Reviewers](../chapters/12-bioinformatics/volcano-plots.qmd#for-reviewers)
